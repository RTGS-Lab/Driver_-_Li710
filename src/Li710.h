...
class LI710: public Sensor
{
	...
	private:
		...
		const uint8_t group0Precision[7] = {3, 1, 1, 2, 2, 2, 2}; //Again, omit SEQ and DIAG
		...
		uint16_t diagWarningMask = 0x70; //Rain, high humidity, cold temperature shutdown as warning, all else as error
		// uint8_t port = 0;
